namespace Bibles.Services
{
    ...
    public class ApiServices
    {
        ...
        public async Task<TokenResponse> LoginFacebook(string urlBase, string servicePrefix, string controller, Models.FacebookResponse profile)
        {
            try
            {
